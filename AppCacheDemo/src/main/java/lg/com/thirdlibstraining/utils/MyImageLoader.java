...
/**
 * MyImageLoader
 * Created by luo gang on 16-11-2.
 */
public class MyImageLoader {
     ...
     * @param reqHeight
     * @return
     * @throws IOException 磁盘缓存的添加：添加需要通过Editor来完成，利用commit和abort方法来 提交 和 撤销 操作
     */
     ...
     * @param reqHeight
     * @return
     * @throws IOException 读取：需要通过Snapshot来完成，通过Snapshot可以得到磁盘缓存对象对应的FileInputStream
